...
source as (
    select * from {{ source('socioeconomic', 'Vestibular_2005_inscritos') }}
),

stage_vestibular_2005 as (
    select
        ano::integer as ano_vestibular,
        inscrica::varchar as codigo_inscricao,
        strptime(nascim, '%d.%m.%Y') as data_nascimento,
        ...
        automovel::varchar as flg_automovel,
        cor::varchar as cor
    from
        source
...
select * from stage_vestibular_2005
