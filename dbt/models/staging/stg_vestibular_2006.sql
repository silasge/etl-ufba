...
source as (
    select * from {{ source('socioeconomic', 'Vestibular_2006_inscritos') }}
),

stage_vestibular_2006 as (
    select
        ano::integer as ano_vestibular,
        inscrica::varchar as codigo_inscricao,
        strptime(nascim, '%Y-%m-%d') as data_nascimento,
        ...
        carro::varchar as flg_automovel,
        cor::varchar as cor
    from
        source
...
select * from stage_vestibular_2006
